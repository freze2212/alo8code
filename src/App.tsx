    ...
    <>
      <div className="relative min-h-screen">
        ...
        <div className="flex flex-col items-center gap-4 sm:gap-5 md:gap-6 w-full max-w-[520px]">
          ...
          <div className="relative w-full max-w-[320px] sm:max-w-[420px] md:max-w-none md:w-auto h-[300px] sm:h-[400px] md:h-[535px] flex items-center justify-center mt-[2.5rem] sm:mt-3 md:mt-4">
            <img
              src="/Vector-1.webp"
