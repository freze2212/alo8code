function Footer() {
  ...
  return (
    <footer className="w-full -mt-[70px] sm:mt-0 bg-[rgba(13,19,41,1)] bg-gradient-to-b from-[rgba(13,19,41,1)] via-[rgba(16,31,83,1)] to-[rgba(13,19,41,1)] text-white">
          ...
          {/* Collab Info */}
           <div className="flex justify-end">
            <div
              ...
              style={{
                background: "linear-gradient(90deg, rgba(25,38,85,1) 0%, rgba(35,85,146,1) 100%)"
              }}
            >
              <div className="flex-1 flex flex-col justify-between">
                <div>
                  <span className="block text-white font-extrabold text-[24px] leading-[131%] mb-1" style={{ fontWeight: 900 }}>
                ...
                <div className="mt-2">
                  <button className="text-white text-sm underline hover:opacity-80 transition">Ẩn bớt</button>
                </div>
              </div>
            ...
            {navLinks.map((label, index) => (
              <>
                ...
                {index < navLinks.length - 1 && (
                  <span key={`sep-${index}`} className="text-[11px] sm:text-[13px] md:text-[17px]">
                    |
                  </span>
                )}
              </>
